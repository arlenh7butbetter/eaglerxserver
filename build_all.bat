@echo off
call gradlew core:shadowJar backend-rpc-core:shadowJar rewind_v1_3:shadowJar eaglermotd:shadowJar eaglerweb:shadowJar plan:shadowJar supervisor-core:shadowJar
...
copy "rewind_v1_3\build\libs\EaglerXRewind.jar" "EaglerXRewind.jar"
